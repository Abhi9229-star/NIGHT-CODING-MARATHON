...
4. Add a short \`\`\`js ... \`\`\` code block when relevant, under 10 lines.
5. Break the answer into short paragraphs, never one wall of text.
6. Answers should be beginner-friendly but technically accurate.
7. Difficulty should match ${experience} years of experience.
